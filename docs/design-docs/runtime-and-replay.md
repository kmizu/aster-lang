...
validates a typed resolution, settles usage, and resumes. State updates remain
pending until successful handler completion.
...
pending request. Resume accepts exactly one matching typed resolution.
